...
if [ "${PLATFORM}" = "win64" ]; then
    ...
    aarch64-linux-android30-clang -c -I./src src/shell.c src/sqlite3.c -D__ANDROID__  -fPIC -static
    llvm-ar rcs libsqlite3.a sqlite3.o shell.o    
    rm sqlite3.o shell.o
    armv7a-linux-androideabi30-clang -c -I./src src/shell.c src/sqlite3.c -D__ANDROID__ -target armv7a-none-linux-android19 -fPIC -static
