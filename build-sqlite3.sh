...
if [ "${PLATFORM}" = "win64" ]; then
    ...
    armv7a-linux-androideabi30-clang -c -I./src -Iandroid-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include src/shell.c src/sqlite3.c -D__ANDROID__ -target -lpthread -ldl -lm -fPIC -static
